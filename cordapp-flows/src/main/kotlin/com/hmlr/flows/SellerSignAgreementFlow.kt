...
/**
 * Initiating flow for seller to sign the agreement
 */
@InitiatingFlow
@StartableByRPC
class SellerSignAgreementFlow(val agreementStateLinearId: String,
                          val sellerSignature: ByteArray): FlowLogic<SignedTransaction>(), FlowLogicCommonMethods {
